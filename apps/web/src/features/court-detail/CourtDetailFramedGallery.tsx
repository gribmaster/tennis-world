...
// CourtDetailFramedGallery — the PRE-v2 lead image + thumbnail strip for Court Detail.
//
// This is the original `CourtDetailGallery`, renamed and otherwise untouched. Feature 78
// redesigned the UNLOCKED page to the v2 prototype (a full-bleed hero band + a separate
// thumbnail strip, see CourtDetailGallery.tsx) and deliberately left the LOCKED page — which
// is Feature 79's scope — rendering exactly as it did before. That page still composes this
// framed 16/10 gallery, so the locked reading of Court Detail is pixel-identical to what
// shipped before the redesign. Do not restyle it here; Feature 79 will replace or retire it.
//
...
export interface CourtDetailFramedGalleryProps {
...
export function CourtDetailFramedGallery({ images, heroImageUrl, courtName }: CourtDetailFramedGalleryProps) {
